...
以往我们作为开源的消费方，开源项目更像是一份免费的午餐，我们不需要知道午餐是怎么做出来的，我们只需要吃好这份午餐（了解开源项目是如何使用）就可以了；随着我们深入参与开源，成为"免费午餐"的生产方，想通过开源来为我们创新的步伐助力的时候，我们会发现我们知之甚少，急切需要有一份详尽的手册帮助我们了解开源，做好开源。
